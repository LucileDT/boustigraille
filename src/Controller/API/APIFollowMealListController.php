...
class APIFollowMealListController extends AbstractController
{
    ...
    public function toggleFollow(EntityManagerInterface $entityManager): JsonResponse
    {
    ...
    public function acceptFollow(EntityManagerInterface $entityManager): JsonResponse
    {
        // Commented for notifications and follow rework
        // if (!$this->isAuthorized($notificationReceipt)) {
            return new JsonResponse(['not allowed']);
    ...
    public function refuseFollow(EntityManagerInterface $entityManager): JsonResponse
    {
        // Commented for notifications and follow rework
        // if (!$this->isAuthorized($notificationReceipt)) {
            return new JsonResponse(['not allowed']);
